...
const allAlumniData = [
  ...
  { id: 6, name: "Prof. Sanjay Kumar Singh", branch: "Electrical Engineering", branchCode: "EE", passingYear: "1995", jobProfile: "Professor at IIM Lucknow", image: "sanjay_singh.jpeg", isTopAlumni: false, linkedin: null },
  ...
  { id: 50, name: "Suneeta Singh", branch: "Electronics & Communication Engineering", branchCode: "ECE", passingYear: "1989", jobProfile: "Retd. Additional Director General (ADG), Uttar Pradesh Police. Recipient of President's Medal.", image: null, isTopAlumni: false, linkedin: null },
  ...
  { id: 60, name: "Dr. Amit Dhiman", branch: "Chemical Engineering", branchCode: "CHE", passingYear: "2000", jobProfile: "Professor at Department of Chemical Engineering, IIT Roorkee", image: null, isTopAlumni: false, linkedin: null },
  { id: 61, name: "Dr. Manik Chandra", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1998", jobProfile: "Professor & Dean (Alumni) at Institute of Engineering & Technology, Lucknow", image: null, isTopAlumni: false, linkedin: null },
  { id: 62, name: "Manisha Agarwala", branch: "Electronics & Communication Engineering", branchCode: "ECE", passingYear: "1988", jobProfile: "Highly technical professional with over several years of project management experience. Holds over 40 patents.", image: "manisha_agarwala.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/manisha-agarwala-7667732a" },
  { id: 63, name: "P. V. Srinivas", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1988", jobProfile: "Executive Director (ED) at Synopsys Inc", image: null, isTopAlumni: false, linkedin: "https://www.linkedin.com/in/pv-srinivas-1b5bb53" },
  { id: 64, name: "Pankaj Khanna", branch: "Computer Science", branchCode: "CS", passingYear: "1988", jobProfile: "Professional at Apple Inc.", image: "pankaj_khanna.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/pankaj-khanna-98b3605" },
  { id: 65, name: "Devesh Gupta", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1988", jobProfile: "Experienced technology professional", image: "devesh_gupta.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/devesh-gupta-947a78" },
  { id: 66, name: "Neelam D.", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1989", jobProfile: "Technology professional", image: "neelam_dwivedi.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/neelamd" },
  { id: 67, name: "B. M. Sharma", branch: "Not Specified", branchCode: "", passingYear: "1989", jobProfile: "Author & Educator. Training students for IIT-JEE for over 30 years. Published books for JEE training through Cengage Learning.", image: "bm_sharma.webp", isTopAlumni: false, linkedin: null },
  { id: 68, name: "Ravi Gupta", branch: "Civil Engineering", branchCode: "CE", passingYear: "1989", jobProfile: "IES (Indian Engineering Services) / MES (Military Engineering Services) officer", image: "ravi_gupta.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/ravi-gupta-b260b226" },

  // ==================== NEW ADDITIONS (June 8, 2026) ====================
  { id: 69, name: "Samir Tripathi", branch: "Electrical Engineering", branchCode: "EE", passingYear: "1991", jobProfile: "Founder & CMD, Medhaj Techno Concept Pvt. Ltd. National Awardee (MSME) – Outstanding Entrepreneurship. Astrology Educator & Vedic Wisdom Practitioner.", image: "samir_tripathi.jpg", isTopAlumni: false, linkedin: null },
  { id: 70, name: "Shravan Katiyar", branch: "Information Technology", branchCode: "IT", passingYear: "2010", jobProfile: "Founder, Managing Director & Chief Mentor at Career Crave Education Center, Kanpur. Premier institute for IIT-JEE (Main & Advanced) preparation.", image: "shravan_katiyar.jpg", isTopAlumni: false, linkedin: null },
  { id: 71, name: "Er. Ajay Chaudhary", branch: "Electronics & Communication Engineering", branchCode: "ECE", passingYear: "1989", jobProfile: "Chairman, Softpro Group. Chairman, Seth Anandram Jaipuria School, Sadhu Campus, Fatehpur Barabanki.", image: null, isTopAlumni: false, linkedin: null },
  { id: 72, name: "Abhinav Verma", branch: "Electrical Engineering", branchCode: "EE", passingYear: "1991", jobProfile: "Executive Director at Power Grid Corporation of India Ltd.", image: null, isTopAlumni: false, linkedin: "https://www.linkedin.com/in/abhinav-verma-2b26014" },
  { id: 73, name: "Ravi Jain", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1988", jobProfile: "Director, Software Development at Adobe Systems", image: "ravi_jain.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/ravi-jain-8b14aa" },
  { id: 74, name: "Smita Khare", branch: "Electronics & Communication Engineering", branchCode: "ECE", passingYear: "1989", jobProfile: "Global Head of Digital: Data Center Operations", image: "smita_khare.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/smita-khare-8842767" },
  { id: 75, name: "Shuchi Dikshit", branch: "Computer Science & Engineering", branchCode: "CSE", passingYear: "1989", jobProfile: "Location Leader for Tech Ecosystem at McKinsey India | Global Group Leader for Finance Financials Products at McKinsey & Company", image: "shuchi_dikshit.jpg", isTopAlumni: false, linkedin: "https://www.linkedin.com/in/shuchidikshit" },
  { id: 76, name: "Rohhit P Jain", branch: "Mechanical Engineering", branchCode: "ME", passingYear: "1993", jobProfile: "Founder & CMD of a business venture", image: null, isTopAlumni: false, linkedin: null }
];
